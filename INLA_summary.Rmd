...
Examples - a one of waste spill into a river might affect the macroinverts in neighbouring streams, but only for a short period of time. A wildfire might affect chances of tornados in neighbouring counties, but only in one year.
